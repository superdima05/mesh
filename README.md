...
# Текущий статус 🗿
  ...
  [:heavy_check_mark:] Библиотека в рабочем состоянии (31.08.2021.). Однако, иногда потребуется авторизация через аккаунт МЭШ (очень редко, но бывает). В этих случаях вставьте свой логин и пароль от МЭШ в переменные "login" и "password" в функции auth().
